...
mixin _$ErrorLoginStore on _ErrorLoginStore, Store {
  final _$errorMessageAtom = Atom(name: '_ErrorLoginStore.errorMessage');
  ...
  final _$showErrorAtom = Atom(name: '_ErrorLoginStore.showError');
