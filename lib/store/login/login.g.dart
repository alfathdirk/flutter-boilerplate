...
mixin _$FormLoginStore on _FormLoginStore, Store {
  ...
  final _$dataListAtom = Atom(name: '_FormLoginStore.dataList');

  @override
  PostLogin get dataList {
  ...
  final _$userEmailAtom = Atom(name: '_FormLoginStore.userEmail');
  ...
  final _$confirmPasswordAtom = Atom(name: '_FormLoginStore.confirmPassword');
  ...
  final _$successAtom = Atom(name: '_FormLoginStore.success');
  ...
  final _$loadingAtom = Atom(name: '_FormLoginStore.loading');
  ...
  final _$getTokenAsyncAction = AsyncAction('getToken');
